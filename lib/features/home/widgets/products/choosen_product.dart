...
class ChoosenProductForHome extends StatefulWidget {
   final List<ProductModel> productModelList;
  const ChoosenProductForHome({required this.productModelList});

  @override
  State<ChoosenProductForHome> createState() => _ChoosenProductForHomeState();
}

class _ChoosenProductForHomeState extends State<ChoosenProductForHome> {
  double rating = 3.5;
  @override
